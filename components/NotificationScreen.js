...
const notificationsData = {
  Jobs: [
    ...
    },
    {
      ...
      content:
        "Join us as a Frontend Developer at Innovate Corp. Remote work available.",
      image: require("../assets/BG.jpg"), // Adjust the path as necessary
      timestamp: "2d ago",
    },
    {
  ...
  Skills: [
    ...
    },
    {
      ...
      content:
        "Attend a seminar on modern web development practices this Friday.",
      image: require("../assets/BG.jpg"), // Adjust the path as necessary
      timestamp: "4d ago",
    },
  ],
  Advice: [
    ...
    },
    {
      ...
      content:
        "Learn how to create a strong personal brand in today’s job market.",
      image: require("../assets/BG.jpg"), // Adjust the path as necessary
      timestamp: "3w ago",
    },
    {
  ...
  Updates: [
    ...
    },
    {
      ...
      content:
        "Scheduled maintenance will occur this weekend. Expect brief downtime.",
      image: require("../assets/BG.jpg"), // Adjust the path as necessary
      timestamp: "3d ago",
    },
  ],
...
const NotificationScreen = ({ route }) => {
  ...
  useFocusEffect(
    useCallback(() => {
      // Automatically clear the badge when this screen is focused
      ...
      <ScrollView style={styles.scene}>
        {notificationsForRoute.map((notification) => (
          <Swipeable
            key={notification.id}
            renderRightActions={() =>
              renderRightActions(route.key, notification.id)
            }
            renderLeftActions={() => renderLeftActions(notification)}
          >
            <View style={styles.notificationContainer}>
              <Image
                style={styles.notificationImgae}
